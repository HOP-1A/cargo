      ...
      <div className="mt-4">
        ...
        <div className="mt-4 flex gap-4">
          ...
          <select className="border p-2 rounded flex-1">
            ...
            <option value="CJ Logistics CJ대한통운">
              CJ Logistics CJ대한통운
            </option>
            <option value="Logen 로젠택배">Logen 로젠택배</option>
            <option value="Korea Post 우체국택배">Korea Post 우체국택배</option>
            <option value="Lotte Global Logistics 롯데택배">
              Lotte Global Logistics 롯데택배
            </option>
            <option value="Hanjin Express 한진택배">
              Hanjin Express 한진택배
            </option>
            <option value="GS postbox">GS postbox</option>
            <option value="COUPANG">COUPANG</option>
            <option value="Costco Wholesale Sangbong">
              Costco Wholesale Sangbong
            </option>
            <option value="경동택배 / Kyungdong Courier">
              경동택배 / Kyungdong Courier
            </option>
          </select>
